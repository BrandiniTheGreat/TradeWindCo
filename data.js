...
const BOATS = [
  ...
  {
    id: 'leopard58-dalliance',
    slug: 'dalliance',
    category: '50ft',
    categoryLabel: '58 ft · 4-cabin + crew',
    year: 2014,
    make: 'Leopard',
    model: '58',
    name: 'Dalliance',
    headline: 'Ex-Moorings Leopard 58 in the BVI — 11-year-old hull, deep-value play with the biggest absolute spread in current inventory.',
    loa: '58\' 0"',
    beam: '28\' 10"',
    draft: '5\' 1"',
    cabins: 4,
    heads: 5,
    berths: 12,
    engines: 'Twin Yanmar 4JH80 — 80 hp ea., saildrives',
    engineHours: 5800,
    fuelGal: 318,
    waterGal: 264,
    sails: 'Main + furling jib + Code-D (factory rig)',
    electronics: 'Raymarine plotter · autopilot · radar',
    extras: 'Onan generator · 4-zone A/C · watermaker · dinghy davits · hardtop bimini · holding tank · electric winches',
    originatingFleet: 'Moorings',
    phaseOutDate: '2024-06-01',
    bviAsk: 629000,
    usRetailComp: 1050000,
    usComps: [
      { year: 2013, make: 'Leopard', model: '58', priceUSD: 949000, location: 'Fort Lauderdale, FL', source: 'YachtWorld', searchUrl: 'https://www.yachtworld.com/boats-for-sale/type-sail/class-catamaran/make-leopard/model-leopard-58/' },
      { year: 2014, make: 'Leopard', model: '58', priceUSD: 1075000, location: 'Annapolis, MD', source: 'The Multihull Company', searchUrl: 'https://www.multihullcompany.com/sailboats-for-sale/' },
      { year: 2015, make: 'Leopard', model: '58', priceUSD: 1175000, location: 'San Diego, CA', source: 'Boat Trader', searchUrl: 'https://www.boattrader.com/sailboats/make-leopard/model-58/' },
    ],
    location: { harbor: 'Road Town', country: 'Tortola, BVI', region: 'British Virgin Islands' },
    destinationPort: 'Fort Lauderdale, FL',
    inspectionWindows: ['Jun 14–21', 'Jul 12–19', 'Aug 16–23'],
    remoteVideoAvailable: true,
    sourceBroker: 'Moorings Brokerage',
    sourceListing: 'mooringsbrokerage.com #7342198',
    sourceUrl: 'https://www.mooringsbrokerage.com/used-boats/2014-leopard-58-virgin-islands-british-dalliance-7342198',
    sourceListed: '2024-05-15',
    sourceLastChecked: '2026-05-18',
    sourcePriceHistory: [
      { date: '2024-05-15', price: 749000 },
      { date: '2025-02-01', price: 689000 },
      { date: '2025-10-15', price: 649000 },
      { date: '2026-03-22', price: 629000 },
    ],
    badge: 'Biggest Spread',
    status: 'available',
    daysActive: 730,
    leads: 4,
    inspections: 0,
    photos: [
      { url: 'photos/leopard58-dalliance/1.jpg', label: 'View 1' },
      { url: 'photos/leopard58-dalliance/2.jpg', label: 'View 2' },
      { url: 'photos/leopard58-dalliance/3.jpg', label: 'View 3' },
      { url: 'photos/leopard58-dalliance/4.jpg', label: 'View 4' },
      { url: 'photos/leopard58-dalliance/5.jpg', label: 'View 5' },
      { url: 'photos/leopard58-dalliance/6.jpg', label: 'View 6' },
      { url: 'photos/leopard58-dalliance/7.jpg', label: 'View 7' },
      { url: 'photos/leopard58-dalliance/8.jpg', label: 'View 8' },
      { url: 'photos/leopard58-dalliance/9.jpg', label: 'View 9' },
      { url: 'photos/leopard58-dalliance/10.jpg', label: 'View 10' },
      { url: 'photos/leopard58-dalliance/11.jpg', label: 'View 11' },
      { url: 'photos/leopard58-dalliance/12.jpg', label: 'View 12' },
      { url: 'photos/leopard58-dalliance/13.jpg', label: 'View 13' },
      { url: 'photos/leopard58-dalliance/14.jpg', label: 'View 14' },
      { url: 'photos/leopard58-dalliance/15.jpg', label: 'View 15' },
      { url: 'photos/leopard58-dalliance/16.jpg', label: 'View 16' },
      { url: 'photos/leopard58-dalliance/17.jpg', label: 'View 17' },
      { url: 'photos/leopard58-dalliance/18.jpg', label: 'View 18' },
      { url: 'photos/leopard58-dalliance/19.jpg', label: 'View 19' },
      { url: 'photos/leopard58-dalliance/20.jpg', label: 'View 20' },
      { url: 'photos/leopard58-dalliance/21.jpg', label: 'View 21' },
      { url: 'photos/leopard58-dalliance/22.jpg', label: 'View 22' },
      { url: 'photos/leopard58-dalliance/23.jpg', label: 'View 23' },
      { url: 'photos/leopard58-dalliance/24.jpg', label: 'View 24' },
      { url: 'photos/leopard58-dalliance/25.jpg', label: 'View 25' },
      { url: 'photos/leopard58-dalliance/26.jpg', label: 'View 26' },
      { url: 'photos/leopard58-dalliance/27.jpg', label: 'View 27' },
      { url: 'photos/leopard58-dalliance/28.jpg', label: 'View 28' },
      { url: 'photos/leopard58-dalliance/29.jpg', label: 'View 29' },
      { url: 'photos/leopard58-dalliance/30.jpg', label: 'View 30' },
      { url: 'photos/leopard58-dalliance/31.jpg', label: 'View 31' },
      { url: 'photos/leopard58-dalliance/32.jpg', label: 'View 32' },
      { url: 'photos/leopard58-dalliance/33.jpg', label: 'View 33' },
      { url: 'photos/leopard58-dalliance/34.jpg', label: 'View 34' },
      { url: 'photos/leopard58-dalliance/35.jpg', label: 'View 35' },
      { url: 'photos/leopard58-dalliance/36.jpg', label: 'View 36' },
      { url: 'photos/leopard58-dalliance/37.jpg', label: 'View 37' },
      { url: 'photos/leopard58-dalliance/38.jpg', label: 'View 38' },
      { url: 'photos/leopard58-dalliance/39.jpg', label: 'View 39' },
      { url: 'photos/leopard58-dalliance/40.jpg', label: 'View 40' },
      { url: 'photos/leopard58-dalliance/41.jpg', label: 'View 41' },
      { url: 'photos/leopard58-dalliance/42.jpg', label: 'View 42' },
      { url: 'photos/leopard58-dalliance/43.jpg', label: 'View 43' },
      { url: 'photos/leopard58-dalliance/44.jpg', label: 'View 44' },
      { url: 'photos/leopard58-dalliance/45.jpg', label: 'View 45' },
      { url: 'photos/leopard58-dalliance/46.jpg', label: 'View 46' },
      { url: 'photos/leopard58-dalliance/47.jpg', label: 'View 47' },
      { url: 'photos/leopard58-dalliance/48.jpg', label: 'View 48' },
      { url: 'photos/leopard58-dalliance/49.jpg', label: 'View 49' },
      { url: 'photos/leopard58-dalliance/50.jpg', label: 'View 50' },
      { url: 'photos/leopard58-dalliance/51.jpg', label: 'View 51' },
      { url: 'photos/leopard58-dalliance/52.jpg', label: 'View 52' },
      { url: 'photos/leopard58-dalliance/53.jpg', label: 'View 53' },
      { url: 'photos/leopard58-dalliance/54.jpg', label: 'View 54' },
      { url: 'photos/leopard58-dalliance/55.jpg', label: 'View 55' },
      { url: 'photos/leopard58-dalliance/56.jpg', label: 'View 56' },
      { url: 'photos/leopard58-dalliance/57.jpg', label: 'View 57' },
      { url: 'photos/leopard58-dalliance/58.jpg', label: 'View 58' },
      { url: 'photos/leopard58-dalliance/59.jpg', label: 'View 59' },
      { url: 'photos/leopard58-dalliance/60.jpg', label: 'View 60' },
      { url: 'photos/leopard58-dalliance/61.jpg', label: 'View 61' },
      { url: 'photos/leopard58-dalliance/62.jpg', label: 'View 62' },
      { url: 'photos/leopard58-dalliance/63.jpg', label: 'View 63' },
      { url: 'photos/leopard58-dalliance/64.jpg', label: 'View 64' },
      { url: 'photos/leopard58-dalliance/65.jpg', label: 'View 65' },
      { url: 'photos/leopard58-dalliance/66.jpg', label: 'View 66' },
      { url: 'photos/leopard58-dalliance/67.jpg', label: 'View 67' },
      { url: 'photos/leopard58-dalliance/68.jpg', label: 'View 68' },
      { url: 'photos/leopard58-dalliance/69.jpg', label: 'View 69' },
      { url: 'photos/leopard58-dalliance/70.jpg', label: 'View 70' },
      { url: 'photos/leopard58-dalliance/71.jpg', label: 'View 71' },
      { url: 'photos/leopard58-dalliance/72.jpg', label: 'View 72' },
      { url: 'photos/leopard58-dalliance/73.jpg', label: 'View 73' },
      { url: 'photos/leopard58-dalliance/74.jpg', label: 'View 74' },
      { url: 'photos/leopard58-dalliance/75.jpg', label: 'View 75' },
      { url: 'photos/leopard58-dalliance/76.jpg', label: 'View 76' },
      { url: 'photos/leopard58-dalliance/77.jpg', label: 'View 77' },
      { url: 'photos/leopard58-dalliance/78.jpg', label: 'View 78' },
      { url: 'photos/leopard58-dalliance/79.jpg', label: 'View 79' },
      { url: 'photos/leopard58-dalliance/80.jpg', label: 'View 80' },
      { url: 'photos/leopard58-dalliance/81.jpg', label: 'View 81' },
      { url: 'photos/leopard58-dalliance/82.jpg', label: 'View 82' },
      { url: 'photos/leopard58-dalliance/83.jpg', label: 'View 83' },
      { url: 'photos/leopard58-dalliance/84.jpg', label: 'View 84' },
      { url: 'photos/leopard58-dalliance/85.jpg', label: 'View 85' },
      { url: 'photos/leopard58-dalliance/86.jpg', label: 'View 86' },
      { url: 'photos/leopard58-dalliance/87.jpg', label: 'View 87' },
      { url: 'photos/leopard58-dalliance/88.jpg', label: 'View 88' },
      { url: 'photos/leopard58-dalliance/89.jpg', label: 'View 89' },
      { url: 'photos/leopard58-dalliance/90.jpg', label: 'View 90' },
      { url: 'photos/leopard58-dalliance/91.jpg', label: 'View 91' },
      { url: 'photos/leopard58-dalliance/92.jpg', label: 'View 92' },
      { url: 'photos/leopard58-dalliance/93.jpg', label: 'View 93' },
      { url: 'photos/leopard58-dalliance/94.jpg', label: 'View 94' },
      { url: 'photos/leopard58-dalliance/95.jpg', label: 'View 95' },
      { url: 'photos/leopard58-dalliance/96.jpg', label: 'View 96' },
      { url: 'photos/leopard58-dalliance/97.jpg', label: 'View 97' },
      { url: 'photos/leopard58-dalliance/98.jpg', label: 'View 98' },
      { url: 'photos/leopard58-dalliance/99.jpg', label: 'View 99' },
      { url: 'photos/leopard58-dalliance/100.jpg', label: 'View 100' },
    ],
    photoCount: 100,
    description:
      'Eleven-year-old Leopard 58 from the Moorings BVI charter fleet — a deep-value 58-foot platform at the bottom of its depreciation curve. Four-cabin owner version plus crew quarters, twin Yanmar 4JH80 diesels with saildrives, Onan generator, 4-zone air conditioning, watermaker, dinghy davits. Standard charter-program maintenance documented through 2024. The 2014 hulls represented the second-generation Leopard 58 design before the Robertson & Caine refresh.',
    internalNotes:
      'Highest absolute gross margin in current inventory at ~$160K. Hull age (11 yrs) means tighter survey scrutiny — recommend full rig + osmosis inspection. Four price cuts since May 2024 indicate seller flexibility. Source URL needs to be looked up from Moorings E-List spreadsheet.',
    whyWeSelected:
      'The 2014 Leopard 58s are at the bottom of their depreciation curve — five more years of cruising left in the hull at half the price of a newer 58. Perfect for a buyer who values waterline length over showroom finish.',
  },
  {
    id: 'leopard58-happy-endings',
    slug: 'happy-endings',
    category: '50ft',
    categoryLabel: '58 ft · 4-cabin + crew',
    year: 2020,
    ...
    model: '58',
    name: 'Happy Endings',
    headline: 'Premium 2020 Leopard 58 phase-out — the bigger boat, the larger absolute spread.',
    loa: '58\' 0"',
    beam: '28\' 10"',
    draft: '5\' 1"',
    cabins: 4,
    heads: 5,
    berths: 12,
    engines: 'Twin Yanmar 4JH80T — 80 hp ea., saildrives',
    engineHours: 3200,
    fuelGal: 318,
    waterGal: 264,
    sails: 'Main + furling jib + Code-D (factory rig) · electric primary winches',
    electronics: 'Raymarine Axiom plotter · autopilot · radar · ADS-B AIS',
    extras: 'Onan 17 kW generator · 4-zone A/C · Sea Recovery watermaker · solar bimini · dinghy davits · hardtop · electric flush heads',
    originatingFleet: 'Moorings',
    phaseOutDate: '2025-09-10',
    bviAsk: 985000,
    usRetailComp: 1550000,
    usComps: [
      { year: 2019, make: 'Leopard', model: '58', priceUSD: 1395000, location: 'Miami, FL', source: 'YachtWorld', searchUrl: 'https://www.yachtworld.com/boats-for-sale/type-sail/class-catamaran/make-leopard/model-leopard-58/' },
      { year: 2020, make: 'Leopard', model: '58', priceUSD: 1575000, location: 'Annapolis, MD', source: 'The Multihull Company', searchUrl: 'https://www.multihullcompany.com/sailboats-for-sale/' },
      { year: 2021, make: 'Leopard', model: '58', priceUSD: 1675000, location: 'Newport, RI', source: 'Boat Trader', searchUrl: 'https://www.boattrader.com/sailboats/make-leopard/model-58/' },
    ],
    location: { harbor: 'Road Town', country: 'Tortola, BVI', region: 'British Virgin Islands' },
    destinationPort: 'Fort Lauderdale, FL',
    inspectionWindows: ['Jun 21–28', 'Jul 26–Aug 2', 'Sep 13–20'],
    remoteVideoAvailable: true,
    sourceBroker: 'Moorings Brokerage',
    sourceListing: 'mooringsbrokerage.com #9920293',
    sourceUrl: 'https://www.mooringsbrokerage.com/used-boats/2020-leopard-58-virgin-islands-british-happy-endings-9920293',
    sourceListed: '2025-10-05',
    sourceLastChecked: '2026-05-18',
    sourcePriceHistory: [
      { date: '2025-10-05', price: 1095000, price_note: 'Original ask' },
      { date: '2026-02-14', price: 1035000 },
      { date: '2026-05-01', price: 985000 },
    ],
    badge: 'Premium 58',
    status: 'available',
    daysActive: 225,
    ...
    inspections: 0,
    photos: [
      { url: 'photos/leopard58-happy-endings/1.jpg', label: 'View 1' },
      { url: 'photos/leopard58-happy-endings/2.jpg', label: 'View 2' },
      { url: 'photos/leopard58-happy-endings/3.jpg', label: 'View 3' },
      { url: 'photos/leopard58-happy-endings/4.jpg', label: 'View 4' },
      { url: 'photos/leopard58-happy-endings/5.jpg', label: 'View 5' },
      { url: 'photos/leopard58-happy-endings/6.jpg', label: 'View 6' },
      { url: 'photos/leopard58-happy-endings/7.jpg', label: 'View 7' },
      { url: 'photos/leopard58-happy-endings/8.jpg', label: 'View 8' },
      { url: 'photos/leopard58-happy-endings/9.jpg', label: 'View 9' },
      { url: 'photos/leopard58-happy-endings/10.jpg', label: 'View 10' },
      { url: 'photos/leopard58-happy-endings/11.jpg', label: 'View 11' },
      { url: 'photos/leopard58-happy-endings/12.jpg', label: 'View 12' },
      { url: 'photos/leopard58-happy-endings/13.jpg', label: 'View 13' },
      { url: 'photos/leopard58-happy-endings/14.jpg', label: 'View 14' },
      { url: 'photos/leopard58-happy-endings/15.jpg', label: 'View 15' },
      { url: 'photos/leopard58-happy-endings/16.jpg', label: 'View 16' },
      { url: 'photos/leopard58-happy-endings/17.jpg', label: 'View 17' },
      { url: 'photos/leopard58-happy-endings/18.jpg', label: 'View 18' },
      { url: 'photos/leopard58-happy-endings/19.jpg', label: 'View 19' },
      { url: 'photos/leopard58-happy-endings/20.jpg', label: 'View 20' },
      { url: 'photos/leopard58-happy-endings/21.jpg', label: 'View 21' },
      { url: 'photos/leopard58-happy-endings/22.jpg', label: 'View 22' },
      { url: 'photos/leopard58-happy-endings/23.jpg', label: 'View 23' },
      { url: 'photos/leopard58-happy-endings/24.jpg', label: 'View 24' },
      { url: 'photos/leopard58-happy-endings/25.jpg', label: 'View 25' },
      { url: 'photos/leopard58-happy-endings/26.jpg', label: 'View 26' },
      { url: 'photos/leopard58-happy-endings/27.jpg', label: 'View 27' },
      { url: 'photos/leopard58-happy-endings/28.jpg', label: 'View 28' },
      { url: 'photos/leopard58-happy-endings/29.jpg', label: 'View 29' },
      { url: 'photos/leopard58-happy-endings/30.jpg', label: 'View 30' },
      { url: 'photos/leopard58-happy-endings/31.jpg', label: 'View 31' },
      { url: 'photos/leopard58-happy-endings/32.jpg', label: 'View 32' },
      { url: 'photos/leopard58-happy-endings/33.jpg', label: 'View 33' },
      { url: 'photos/leopard58-happy-endings/34.jpg', label: 'View 34' },
      { url: 'photos/leopard58-happy-endings/35.jpg', label: 'View 35' },
      { url: 'photos/leopard58-happy-endings/36.jpg', label: 'View 36' },
      { url: 'photos/leopard58-happy-endings/37.jpg', label: 'View 37' },
      { url: 'photos/leopard58-happy-endings/38.jpg', label: 'View 38' },
      { url: 'photos/leopard58-happy-endings/39.jpg', label: 'View 39' },
      { url: 'photos/leopard58-happy-endings/40.jpg', label: 'View 40' },
      { url: 'photos/leopard58-happy-endings/41.jpg', label: 'View 41' },
      { url: 'photos/leopard58-happy-endings/42.jpg', label: 'View 42' },
      { url: 'photos/leopard58-happy-endings/43.jpg', label: 'View 43' },
      { url: 'photos/leopard58-happy-endings/44.jpg', label: 'View 44' },
      { url: 'photos/leopard58-happy-endings/45.jpg', label: 'View 45' },
      { url: 'photos/leopard58-happy-endings/46.jpg', label: 'View 46' },
      { url: 'photos/leopard58-happy-endings/47.jpg', label: 'View 47' },
      { url: 'photos/leopard58-happy-endings/48.jpg', label: 'View 48' },
      { url: 'photos/leopard58-happy-endings/49.jpg', label: 'View 49' },
      { url: 'photos/leopard58-happy-endings/50.jpg', label: 'View 50' },
      { url: 'photos/leopard58-happy-endings/51.jpg', label: 'View 51' },
      { url: 'photos/leopard58-happy-endings/52.jpg', label: 'View 52' },
      { url: 'photos/leopard58-happy-endings/53.jpg', label: 'View 53' },
      { url: 'photos/leopard58-happy-endings/54.jpg', label: 'View 54' },
      { url: 'photos/leopard58-happy-endings/55.jpg', label: 'View 55' },
      { url: 'photos/leopard58-happy-endings/56.jpg', label: 'View 56' },
      { url: 'photos/leopard58-happy-endings/57.jpg', label: 'View 57' },
      { url: 'photos/leopard58-happy-endings/58.jpg', label: 'View 58' },
      { url: 'photos/leopard58-happy-endings/59.jpg', label: 'View 59' },
      { url: 'photos/leopard58-happy-endings/60.jpg', label: 'View 60' },
      { url: 'photos/leopard58-happy-endings/61.jpg', label: 'View 61' },
      { url: 'photos/leopard58-happy-endings/62.jpg', label: 'View 62' },
      { url: 'photos/leopard58-happy-endings/63.jpg', label: 'View 63' },
      { url: 'photos/leopard58-happy-endings/64.jpg', label: 'View 64' },
      { url: 'photos/leopard58-happy-endings/65.jpg', label: 'View 65' },
      { url: 'photos/leopard58-happy-endings/66.jpg', label: 'View 66' },
    ],
    photoCount: 66,
    description:
      'Newer 2020 Leopard 58 phase-out — the redesigned third-generation hull with Axiom electronics, solar bimini, and electric flush heads. Twin Yanmar 4JH80T turbodiesels with saildrives, Onan 17kW generator, Sea Recovery watermaker, dinghy davits, hardtop. Four-cabin owner-version layout plus crew quarters. The Leopard 58 is the largest production Robertson & Caine cat — full-time-cruising capability with charter-fleet maintenance discipline.',
    internalNotes:
      'Larger absolute spread than Dalliance (~$155K gross) at lower hull-age risk. 3,200 hours is moderate for a 5-year-old 58 in charter service. Source URL needs Moorings E-List lookup. Premium positioning supports higher $1.55M comp.',
    whyWeSelected:
      'The 2020 Leopard 58 with 3,200 charter hours is the rare combination of premium platform plus motivated-seller economics. Larger boats carry larger absolute spreads — that is where the dollar-margin compounding starts.',
  },
];
